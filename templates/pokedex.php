    ...
    <div style="margin: 2rem 5rem;">
        ...
        <form method="post">
            <div class="input-group">
                <input type="text" class="form-control" placeholder="Search for a Pokemon by name..." autofocus
            ...
            <div class="mt-4">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="type_list[]" id="normal" value="normal"
                        <?php if (isset($_POST['type_list']) && in_array("normal", $_POST['type_list'])) echo "checked"; ?>>
                    <label class="form-check-label" for="normal">Normal</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="type_list[]" id="fighting" value="fighting"
                        <?php if (isset($_POST['type_list']) && in_array("fighting", $_POST['type_list'])) echo "checked"; ?>>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="type_list[]" id="flying" value="flying"
                        <?php if (isset($_POST['type_list']) && in_array("flying", $_POST['type_list'])) echo "checked"; ?>>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="type_list[]" id="poison" value="poison"
                        <?php if (isset($_POST['type_list']) && in_array("poison", $_POST['type_list'])) echo "checked"; ?>>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="type_list[]" id="ground" value="ground"
                        <?php if (isset($_POST['type_list']) && in_array("ground", $_POST['type_list'])) echo "checked"; ?>>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="type_list[]" id="rock" value="rock"
                        <?php if (isset($_POST['type_list']) && in_array("rock", $_POST['type_list'])) echo "checked"; ?>>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="type_list[]" id="bug" value="bug"
                        <?php if (isset($_POST['type_list']) && in_array("bug", $_POST['type_list'])) echo "checked"; ?>>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="type_list[]" id="ghost" value="ghost"
                        <?php if (isset($_POST['type_list']) && in_array("ghost", $_POST['type_list'])) echo "checked"; ?>>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="type_list[]" id="steel" value="steel"
                        <?php if (isset($_POST['type_list']) && in_array("steel", $_POST['type_list'])) echo "checked"; ?>>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="type_list[]" id="fire" value="fire"
                        <?php if (isset($_POST['type_list']) && in_array("fire", $_POST['type_list'])) echo "checked"; ?>>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="type_list[]" id="water" value="water"
                        <?php if (isset($_POST['type_list']) && in_array("water", $_POST['type_list'])) echo "checked"; ?>>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="type_list[]" id="grass" value="grass"
                        <?php if (isset($_POST['type_list']) && in_array("grass", $_POST['type_list'])) echo "checked"; ?>>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="type_list[]" id="electric" value="electric"
                        <?php if (isset($_POST['type_list']) && in_array("electric", $_POST['type_list'])) echo "checked"; ?>>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="type_list[]" id="psychic" value="psychic"
                        <?php if (isset($_POST['type_list']) && in_array("psychic", $_POST['type_list'])) echo "checked"; ?>>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="type_list[]" id="ice" value="ice"
                        <?php if (isset($_POST['type_list']) && in_array("ice", $_POST['type_list'])) echo "checked"; ?>>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="type_list[]" id="dragon" value="dragon"
                        <?php if (isset($_POST['type_list']) && in_array("dragon", $_POST['type_list'])) echo "checked"; ?>>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="type_list[]" id="dark" value="dark"
                        <?php if (isset($_POST['type_list']) && in_array("dark", $_POST['type_list'])) echo "checked"; ?>>
                    <label class="form-check-label" for="dark">Dark</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="type_list[]" id="fairy" value="fairy"
                        <?php if (isset($_POST['type_list']) && in_array("fairy", $_POST['type_list'])) echo "checked"; ?>>
